...
Proyek API Retrofit ini merupakan tugas kelompok yang bertujuan untuk mempelajari dan mengimplementasikan penggunaan Retrofit dalam pengambilan data dari API menggunakan Android Studio. 
...
- internet permission
  ...
  <img width="751" height="143" alt="image" src="https://github.com/user-attachments/assets/0f5e13f7-6ea7-4a33-a0d9-9f25dc814131" />

  Pada file AndroidManifest.xml, tambahkan deklarasi izin internet dengan perintah <uses-permission android:name="android.permission.INTERNET"/>. Izin ini diperlukan agar aplikasi dapat melakukan komunikasi jaringan, seperti mengirim permintaan dan menerima respon dari server melalui API. Karena proyek ini menggunakan Retrofit untuk mengakses data secara online, maka penambahan izin internet menjadi hal yang wajib agar aplikasi dapat berjalan sesuai fungsinya.
...
Kedua, terdapat LinearLayout vertikal dengan padding 15dp yang berfungsi untuk menampilkan teks deskriptif terkait buku. Di dalamnya ada TextView untuk judul buku (tv_judulbuku) yang ditampilkan dengan gaya tebal dan warna hitam agar lebih menonjol.
  ...
  Secara keseluruhan, kode tersebut membentuk satu komponen tampilan berbentuk kartu yang menampilkan gambar buku di sisi kiri, judul buku di bagian atas kanan, serta informasi penulis dan tahun terbit di bawahnya. 
